...
//#define LCD_SHOW_E_TOTAL  //FSMC
  ...
  #define SHOW_REMAINING_TIME       //FSMC// Display estimated time to completion
  #if ENABLED(SHOW_REMAINING_TIME)
    #define USE_M73_REMAINING_TIME  // Use remaining time from M73 command instead of estimation
    #define ROTATE_PROGRESS_DISPLAY //FSMC// Display (P)rogress, (E)lapsed, and (R)emaining time
  #endif
 ...
 */
  ...
  //#define MESH_MIN_X - ((X_BED_SIZE) - (MESH_INSET))                 ///
  //#define MESH_MIN_Y - ((Y_BED_SIZE) - (MESH_INSET))                ///
...
#define MIN_STEPS_PER_SEGMENT 1 //CAL (6 is too fast)
...
#define TX_BUFFER_SIZE 32 //0 OCTO 32
...
#define SERIAL_FLOAT_PRECISION 4  //OPT /5
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)   //17HS13-404S
    #define E0_CURRENT      280 //Imax=0.4A Vref=0.28
...
*/
  ...
  #define E0_HYBRID_THRESHOLD    152
